        ...
        const generatedContent = [{"campaign_id": "6a64cf756cdfd98478f11f28", "campaign_name": "Million Hospitality", "section": "Nuove", "feasibility_score": 30500.6, "feasibility_rating": "ALTA", "feasibility_reasoning": "La campagna ha ancora un budget di quasi 1000€, un alto payout di 1€ ogni 1000 views e un target ampio come quello dei lavoratori nell'hospitality in Italia insoddisfatti dei propri stipendi. L'interesse per l'espatrio e alti guadagni è altissimo.", "payout_per_1k": 1.0, "daily_video_goal": "3-4 video al giorno", "best_video_type": "Hybrid Storytelling (B-Roll di lusso all'estero + Facecam Manfredi)", "scripts": [{"concept_name": "Variante Provocatoria (Il Mito dello Stipendio Basso)", "video_prompt_gemini": "Cinematic vertical 9:16 video, 15-30 seconds. Start with an ultra-high-quality, dynamic B-roll of an exhausted bartender in a dark, cheap Italian bar, overlaid with text 'Stanco di prendere 1200€ al mese?'. Fast transition to luxury high-end restaurants in Dubai or London. Text overlay: 'All'estero ne prenderesti 5000€'. IMPORTANT RULES TO FOLLOW EXACTLY: At least 3 seconds of the clip MUST feature the face of Manfredi talking directly to the camera. The 'Million Hospitality' logo must remain clearly visible on screen for the ENTIRE duration of the video. End with a strong visual and the CTA 'Guarda il video completo su Klippify!'. Visuals should look highly polished, like a professional commercial.", "tiktok_caption": "Sei un bartender o lavori nell'hospitality in Italia? Ti stanno fregando. 🛑🍸 Scopri quanto potresti guadagnare all'estero! @lavorare_all_estero #millionhospitality #lavorareallestero #klippify", "storyboard": [{"scene": 1, "duration": "0-3s", "description": "B-roll oscuro e caotico di un bartender o cameriere frustrato.", "text_overlay": "Stanco di prendere 1200€ al mese?"}, {"scene": 2, "duration": "3-6s", "description": "Transizione rapida a resort di lusso, yacht, o ristoranti stellati all'estero. Manfredi entra in scena guardando in camera.", "text_overlay": "All'estero ne prenderesti 5000€"}, {"scene": 3, "duration": "6-10s", "description": "Il volto di Manfredi in primo piano (REGOLA: almeno 3 secondi visibile) mentre parla in modo deciso.", "text_overlay": "Bartender, Chef, Restaurant Manager... Siete ricercatissimi."}, {"scene": 4, "duration": "10-15s", "description": "Schermata di chiusura in stile luxury con il logo dell'azienda ben visibile (come in tutta la clip).", "text_overlay": "Guarda il video completo su Klippify!"}]}, {"concept_name": "Variante Aspirazionale (La Vita da Sogno)", "video_prompt_gemini": "Cinematic vertical 9:16 video, 15-30 seconds. Aesthetically pleasing luxury lifestyle B-roll: a sommelier pouring expensive wine in a skyscraper with a sunset view, an elegant chef de rang serving gourmet food. Text overlay: 'La vera vita di chi lavora nell'hospitality all'estero'. The vibe is wealthy, clean, and aspirational. IMPORTANT RULES TO ENFORCE: The face of Manfredi must appear in the video, talking directly to the viewer, for a minimum of 3 full seconds. The 'Million Hospitality' logo must be continuously visible in the corner from the very first frame to the last. End with text 'Guarda il video completo su Klippify!'. High contrast, golden hour lighting.", "tiktok_caption": "Questa è la vita che ti meriti. ✈️🥂 Da 4K a 9K al mese, minimo 48K l'anno. Il tuo talento vale molto di più! @lavorare_all_estero #millionhospitality #lavorareallestero #klippify", "storyboard": [{"scene": 1, "duration": "0-3s", "description": "Immagini mozzafiato di un sommelier che serve vino in un ristorante esclusivo con vista su una metropoli.", "text_overlay": "La vera vita nell'hospitality all'estero"}, {"scene": 2, "duration": "3-8s", "description": "Montaggio dinamico di lifestyle lussuoso (auto eleganti, appartamenti moderni).", "text_overlay": "Da 4K a 9K al mese. Minimo 48.000€ l'anno."}, {"scene": 3, "duration": "8-12s", "description": "Il volto di Manfredi in primo piano (REGOLA: almeno 3 secondi visibile) che annuisce e spiega l'opportunità.", "text_overlay": "Sei un talento, fatti pagare per quanto vali."}, {"scene": 4, "duration": "12-15s", "description": "Ultimi frame eleganti con il logo sempre visibile.", "text_overlay": "Guarda il video completo su Klippify!"}]}, {"concept_name": "Variante Informativa (I 3 Lavori più Pagati)", "video_prompt_gemini": "Fast-paced vertical 9:16 video, 15-30 seconds. Listicle style. Upbeat, dynamic edits showing 3 different hospitality jobs: 1. Chef, 2. Sommelier, 3. Restaurant Manager. Text overlay counts down 'I 3 lavori da strapagati all'estero'. Modern, crisp aesthetics with motion blur transitions. STRICT REQUIREMENTS: A person named Manfredi must have his face on-screen for at least 3 seconds delivering the hook or conclusion. The brand logo must be overlaid on the video permanently. The final scene must display the call to action 'Guarda il video completo su Klippify!'.", "tiktok_caption": "I 3 lavori nell'hospitality dove puoi guadagnare più di 5000€ al mese 🤯💸 Prepara le valigie! @lavorare_all_estero #millionhospitality #lavorareallestero #klippify", "storyboard": [{"scene": 1, "duration": "0-3s", "description": "Hook veloce con Manfredi in primo piano (REGOLA: almeno 3 sec) che alza 3 dita.", "text_overlay": "I 3 lavori da strapagati all'estero"}, {"scene": 2, "duration": "3-7s", "description": "Clip di un Restaurant Manager che gestisce uno staff impeccabile. Logo sempre visibile.", "text_overlay": "1. Restaurant Manager (Fino a 9K/mese)"}, {"scene": 3, "duration": "7-10s", "description": "Clip di uno Chef in una cucina ultra-moderna e spaziosa.", "text_overlay": "2. Chef de Cuisine (Fino a 8K/mese)"}, {"scene": 4, "duration": "10-13s", "description": "Clip di un Bartender acrobatico in un locale di lusso.", "text_overlay": "3. Bartender (Oltre 4K/mese + mance)"}, {"scene": 5, "duration": "13-16s", "description": "Chiusura forte con l'invito all'azione.", "text_overlay": "Guarda il video completo su Klippify!"}]}]}];
        ...
        function renderStudioCards() {
            const grid = document.getElementById('studio-cards-grid');
            if (grid.children.length > 0) return;

            generatedContent.forEach((item, idx) => {
                // Find original campaign data for rules/brief
                const originalCamp = allCampaignsData.find(c => c.campaign_token === item.campaign_id || c.id === item.campaign_id) || {};
                const originalBrief = originalCamp.description || 'Nessun brief fornito.';
                const originalHashtags = (originalCamp.mandatory_hashtags || []).join(', ') || 'Nessuno';
                const originalMentions = (originalCamp.mandatory_mentions || []).join(', ') || 'Nessuno';
                const originalCTA = originalCamp.call_to_action || 'Nessuna CTA specificata';
                const originalRules = (originalCamp.rules || ['Segui le linee guida Klippify']).map(r => `<li>✓ ${r}</li>`).join('');
                const ratingColor = getRatingColor(item.feasibility_rating);

                // Handle missing fields for backward compatibility
                const dailyGoal = item.daily_video_goal || "Da definire";
                const bestType = item.best_video_type || "Video standard";
                
                // If it's the old structure, map it to a single script list
                const scripts = item.scripts ? item.scripts : [{
                    concept_name: "Script Unico",
                    video_prompt_gemini: item.video_prompt_gemini || "",
                    tiktok_caption: item.tiktok_caption || "",
                    storyboard: item.storyboard || []
                }];

                // Build HTML for scripts
                let scriptsHtml = `<div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap:1.5rem; margin-top:1.5rem;">`;
                
                scripts.forEach((script, sIdx) => {
                    const storyboardHtml = (script.storyboard || []).map((s, si) =>
                        `<div style="display:flex; gap:0.8rem; align-items:flex-start; padding:0.6rem 0; border-bottom:1px solid rgba(255,255,255,0.05);">`
                        + `<div style="min-width:40px; height:40px; border-radius:0.6rem; background:rgba(255,255,255,0.1); display:flex; align-items:center; justify-content:center; font-weight:700; font-size:0.8rem;">S${si+1}</div>`
                        + `<div><div style="font-weight:600; font-size:0.8rem; color:#f8fafc;">⏱ ${s.duration}</div>`
                        + `<div style="font-size:0.8rem; color:#94a3b8; margin-top:0.2rem;">📹 ${s.description}</div>`
                        + `<div style="font-size:0.75rem; color:#38bdf8; margin-top:0.2rem;">💬 "${s.text_overlay}"</div></div></div>`
                    ).join('');

                    scriptsHtml += `
                        <div style="background:rgba(15,23,42,0.6); border:1px solid rgba(255,255,255,0.1); border-radius:1rem; padding:1.2rem; display:flex; flex-direction:column; gap:1rem;">
                            <h4 style="font-size:1.1rem; color:#fff; border-bottom:1px solid rgba(255,255,255,0.1); padding-bottom:0.5rem; margin:0;">📝 ${script.concept_name}</h4>
                            
                            <!-- PROMPT VIDEO GEMINI -->
                            <div style="background:rgba(139,92,246,0.08); border:1px solid rgba(139,92,246,0.2); border-radius:0.8rem; padding:1rem;">
                                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:0.6rem;">
                                    <span style="font-weight:700; font-size:0.85rem; color:#c084fc;">🎬 Prompt Video per Gemini</span>
                                    <button onclick="copyToClipboard(generatedContent[${idx}].scripts ? generatedContent[${idx}].scripts[${sIdx}].video_prompt_gemini : generatedContent[${idx}].video_prompt_gemini, this)" style="background:linear-gradient(135deg,#8b5cf6,#4f46e5); color:white; border:none; padding:0.3rem 0.8rem; border-radius:0.5rem; font-size:0.7rem; font-weight:700; cursor:pointer;">Copia Prompt</button>
                                </div>
                                <div style="font-size:0.8rem; color:#e2e8f0; line-height:1.5; max-height:150px; overflow-y:auto;">${script.video_prompt_gemini}</div>
                            </div>

                            <!-- CAPTION TIKTOK -->
                            <div style="background:rgba(16,185,129,0.08); border:1px solid rgba(16,185,129,0.2); border-radius:0.8rem; padding:1rem;">
                                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:0.6rem;">
                                    <span style="font-weight:700; font-size:0.85rem; color:#34d399;">📱 Caption TikTok</span>
                                    <button onclick="copyToClipboard(generatedContent[${idx}].scripts ? generatedContent[${idx}].scripts[${sIdx}].tiktok_caption : generatedContent[${idx}].tiktok_caption, this)" style="background:linear-gradient(135deg,#10b981,#059669); color:white; border:none; padding:0.3rem 0.8rem; border-radius:0.5rem; font-size:0.7rem; font-weight:700; cursor:pointer;">Copia Caption</button>
                                </div>
                                <div style="font-size:0.8rem; color:#e2e8f0; line-height:1.4;">${script.tiktok_caption}</div>
                            </div>

                            <!-- STORYBOARD -->
                            <div style="background:rgba(56,189,248,0.06); border:1px solid rgba(56,189,248,0.15); border-radius:0.8rem; padding:1rem; flex-grow:1;">
                                <span style="font-weight:700; font-size:0.85rem; color:#38bdf8; display:block; margin-bottom:0.5rem;">🎬 Storyboard</span>
                                <div style="max-height:200px; overflow-y:auto;">${storyboardHtml}</div>
                            </div>
                        </div>
                    `;
                });
                ...
                const card = document.createElement('div');
                card.style.cssText = 'background:rgba(30,41,59,0.9); border:1px solid rgba(255,255,255,0.1); border-radius:1.5rem; box-shadow:0 20px 40px rgba(0,0,0,0.4); overflow:hidden; margin-bottom:2rem; padding:2rem;';
                card.innerHTML = `
                    <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:1.5rem; border-bottom:1px solid rgba(255,255,255,0.1); padding-bottom:1.5rem;">
                        <div>
                            <h2 style="font-size:1.8rem; font-weight:900; color:#f8fafc; margin-bottom:0.5rem;">${item.campaign_name}</h2>
                            <div style="display:flex; gap:0.6rem; flex-wrap:wrap; font-size:0.85rem;">
                                <span style="background:rgba(139,92,246,0.2); color:#c084fc; padding:0.3rem 0.8rem; border-radius:0.5rem; font-weight:700;">${item.section}</span>
                                <span style="background:rgba(16,185,129,0.15); color:#34d399; padding:0.3rem 0.8rem; border-radius:0.5rem; font-weight:700;">$${item.payout_per_1k}/1k views</span>
                                <span style="background:${ratingColor}22; color:${ratingColor}; padding:0.3rem 0.8rem; border-radius:0.5rem; font-weight:700;">Score: ${item.feasibility_score}</span>
                            </div>
                        </div>
                        <div style="display:flex; gap:1rem;">
                            <div style="background:linear-gradient(135deg, rgba(245,158,11,0.1), rgba(217,119,6,0.2)); border:1px solid rgba(245,158,11,0.3); padding:1rem; border-radius:1rem; text-align:center;">
                                <div style="font-size:0.75rem; color:#fbbf24; text-transform:uppercase; font-weight:800; margin-bottom:0.3rem;">🎯 Obiettivo</div>
                                <div style="font-size:1.2rem; font-weight:900; color:#fff;">${dailyGoal}</div>
                            </div>
                            <div style="background:linear-gradient(135deg, rgba(56,189,248,0.1), rgba(2,132,199,0.2)); border:1px solid rgba(56,189,248,0.3); padding:1rem; border-radius:1rem; text-align:center;">
                                <div style="font-size:0.75rem; color:#38bdf8; text-transform:uppercase; font-weight:800; margin-bottom:0.3rem;">📹 Format Migliore</div>
                                <div style="font-size:1.2rem; font-weight:900; color:#fff;">${bestType}</div>
                            </div>
                        </div>
                    </div>

                    <div style="font-size:0.9rem; color:#cbd5e1; margin-bottom:1.5rem; line-height:1.6;">
                        <strong>💡 Strategia IA:</strong> ${item.feasibility_reasoning}
                    </div>

                    <!-- REQUISITI CAMPAGNA -->
                    <div style="background:rgba(0,0,0,0.2); border:1px solid rgba(255,255,255,0.05); border-radius:1rem; padding:1.5rem; margin-bottom:2rem;">
                        <span style="font-weight:800; font-size:1.1rem; color:#f8fafc; display:block; margin-bottom:1rem;">📋 Requisiti Ufficiali Campagna</span>
                        <div style="font-size:0.9rem; color:#cbd5e1; margin-bottom:1rem; line-height:1.6;"><strong>Brief:</strong> ${originalBrief}</div>
                        <div style="display:flex; flex-wrap:wrap; gap:1.5rem; font-size:0.85rem; margin-bottom:1rem;">
                        ...
                        <div style="font-size:0.85rem; color:#94a3b8;">
                            <strong style="color:#f8fafc;">Regole Inderogabili:</strong>
                            <ul style="margin-top:0.4rem; padding-left:1.2rem; line-height:1.6;">${originalRules}</ul>
                        </div>
                    </div>

                    <h3 style="font-size:1.4rem; font-weight:800; color:#fff; border-left:4px solid #8b5cf6; padding-left:1rem; margin-top:2rem;">🔄 Opzioni di Script (Generazione Multipla)</h3>
                    <p style="font-size:0.9rem; color:var(--text-muted); margin-bottom:0;">Scegli la variante che preferisci per iniziare, usa la CTA corretta e incolla il prompt su Gemini Veo.</p>
